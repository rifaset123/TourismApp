...
) : ViewModelProvider.NewInstanceFactory() { // agar bisa menerima viewmodel generic

    // membaca setiap nilai dari Map dan memeriksa apakah ViewModel tersebut sudah diinisialisasi atau belum.
